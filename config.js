...
module.exports = {
    ...
    BOTSHAH: process.env.BOT_NAME === undefined ? '  SHAH 𝐌𝐖𝐎𝐋࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    ...
    SHAH: process.env.LOGO_LINK === undefined ? 'https://imgur.com/a/5CyIY22.jpg' : process.env.LOGO_LINK,
    MWOL: process.env.BGM_DURATION === undefined ? '7280542' : process.env.BGM_DURATION,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ѕнaн ᴍᴏʟ࿐' : process.env.BOTV2_NAME,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://imgur.com/a/5CyIY22.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ѕнaн ᴍᴏʟ࿐' : process.env.LOGO_NAME,
